clear all;
close all;
vib=textread('E:\bishe实验数据\25600数据\REC3926_ch3.txt','','headerlines',16);
pul=textread('E:\bishe实验数据\25600数据\REC3926_ch2.txt','','headerlines',16);
pluse1=vib(:,1);
vdata=vib(:,2);
...
% 
% s=sig1;
% [tfr,~,~] = tfrstft(s,1:length(s),length(s),hamming(251));
