clear all;
close all;
vib=textread('E:\bishe实验数据\25600数据\REC3950_ch3.txt','','headerlines',16);
pul=textread('E:\bishe实验数据\25600数据\REC3950_ch2.txt','','headerlines',16);
pluse1=vib(:,1);
vdata=vib(:,2);
% pul=pul(:,2);pul=-pul;
threshold=abs(1)/3;
...
% f1=route(12,:);
% f1=route(16,:);3942 3
f1=route(1,:);%5%1-3秒的话是15，2-3的话是7
