clear all;
close all;
vib=textread('I:\bishe实验数据\25600数据\REC3939_ch3.txt','','headerlines',16);
pul=textread('I:\bishe实验数据\25600数据\REC3939_ch2.txt','','headerlines',16);
pluse1=vib(:,1);
vdata=vib(:,2);
% pul=pul(:,2);pul=-pul;
threshold=abs(1)/3;
...
figure;
plot(t,vdata)
xlabel('t/s');ylabel('A/g');title('截取信号');
...
% f1=route(12,:);
% f1=route(16,:);3942 3
f1=route(5,:);%5%1-3秒的话是15，2-3的话是7
